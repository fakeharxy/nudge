...
ActiveRecord::Schema.define(version: 20180316102023) do
  ...
  create_table "completes", force: :cascade do |t|
    ...
    t.index ["second_id"], name: "index_completes_on_second_id", using: :btree
    t.index ["tag_id"], name: "index_completes_on_tag_id", using: :btree
  ...
  add_foreign_key "completes", "seconds"
  add_foreign_key "completes", "tags"
